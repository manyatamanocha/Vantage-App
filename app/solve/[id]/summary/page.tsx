...
export default async function SolveSummaryPage({
  ...
  // A takeaway may simply not exist yet (Handback is on-demand — see
  // app/solve/[id]/handback). That's an expected, not-yet-generated state, not
  // an error — `maybeSingle` returns null data instead of throwing on zero
  // rows, and `solve_id` is unique on `takeaways`
